...
public class Cart {
    ...
    public void printAll() {
        ...
        for(Map.Entry<Product, Integer> entry : cartMap.entrySet()) {
            System.out.println("상품 : "+entry.getKey() + " " + entry.getValue());
        }
    }

    public void minus(Product product, int removeQuantity) {
        Integer existingQuantity = cartMap.getOrDefault(product, 0);
        cartMap.put(product, existingQuantity - removeQuantity);
    }
}
